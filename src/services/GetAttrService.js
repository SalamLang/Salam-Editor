const result = {
  items: [
    ...
    {
      generate_name: "href",
      id: "AST_LAYOUT_ATTRIBUTE_TYPE_SRC_HREF",
      reserved_values: "",
      type: "AST_LAYOUT_ATTRIBUTE_FILTER_STRING_ANY",
      text: {
        en: ["src"],
    ...
    },
    {
      ...
      id: "AST_LAYOUT_ATTRIBUTE_TYPE_LANGUAGE",
      reserved_values: "",
      type: "AST_LAYOUT_ATTRIBUTE_FILTER_STRING_ANY",
      text: {
        en: ["language"],
    ...
    {
      generate_name: "ping",
      id: "AST_LAYOUT_ATTRIBUTE_TYPE_PING",
      reserved_values: "",
      type: "AST_LAYOUT_ATTRIBUTE_FILTER_STRING_ANY",
      text: {
        en: ["ping"],
    ...
    },
    {
      ...
      id: "AST_LAYOUT_ATTRIBUTE_TYPE_REFERRER_POLICY",
      reserved_values: "ast_layout_allowed_referrerpolicy",
    ...
    },
    {
      ...
      reserved_values: "ast_layout_allowed_rel",
      type: "AST_LAYOUT_ATTRIBUTE_FILTER_STRING",
      text: {
        en: ["rel", "relationship"],
        fa: ["رابطه"],
    ...
    },
    {
      ...
      reserved_values: "ast_layout_allowed_form_kind",
      type: "AST_LAYOUT_ATTRIBUTE_FILTER_STRING",
      text: {
        en: ["target"],
        fa: ["هدف"],
    ...
    },
    {
      ...
      type: "AST_LAYOUT_ATTRIBUTE_FILTER_STRING_ANY",
      description: {
        fa: "ویژگی کلاس جهت تنظیم نام کلاس برای یک دستور می‌باشد.",
      },
      text: {
        en: ["class"],
        fa: ["کلاس"],
    ...
    },
    {
      ...
      type: "AST_LAYOUT_ATTRIBUTE_FILTER_STRING_ANY",
      description: {
        fa: "ویژگی شناسه جهت تنظیم شناسه برای یک دستور می‌باشد.",
      },
      text: {
        en: ["id"],
        fa: ["شناسه"],
    ...
    },
    {
      ...
      type: "AST_LAYOUT_ATTRIBUTE_FILTER_STRING_ANY",
      description: {
        fa: "جهت تنظیم یک محتوا به یک دستور می‌باشد.",
      },
      text: {
        en: ["content"],
        fa: ["محتوا"],
    ...
    {
      generate_name: "src",
      value_handler: "AST_LAYOUT_ATTRIBUTE_VALUE_HANDLER_FONT_URL",
    ...
    },
    {
      ...
      reserved_values: "ast_layout_allowed_dir",
      type: "AST_LAYOUT_ATTRIBUTE_FILTER_STRING",
      text: {
        en: ["dir"],
        fa: ["جهت"],
    ...
    {
      generate_name: "lang",
      id: "AST_LAYOUT_ATTRIBUTE_TYPE_LANG",
      reserved_values: "ast_layout_allowed_lang",
      type: "AST_LAYOUT_ATTRIBUTE_FILTER_STRING",
      text: {
        en: ["lang"],
        fa: ["زبان"],
    ...
    },
    {
      ...
      reserved_values: "ast_layout_allowed_form_type",
      type: "AST_LAYOUT_ATTRIBUTE_FILTER_STRING",
      text: {
        en: ["type"],
        fa: ["نوع"],
    ...
    {
      generate_name: "target",
      id: "AST_LAYOUT_ATTRIBUTE_TYPE_KIND",
      reserved_values: "ast_layout_allowed_form_kind",
      type: "AST_LAYOUT_ATTRIBUTE_FILTER_STRING",
      text: {
        en: ["kind"],
    ...
    {
      generate_name: "charset",
      id: "AST_LAYOUT_ATTRIBUTE_TYPE_CHARSET",
      reserved_values: "ast_layout_allowed_charset",
      type: "AST_LAYOUT_ATTRIBUTE_FILTER_STRING",
      text: {
        en: ["charset"],
        fa: ["فرمت متنی"],
    ...
    },
    {
      ...
      id: "AST_LAYOUT_ATTRIBUTE_TYPE_REQUIRED",
      reserved_values: "",
      type: "AST_LAYOUT_ATTRIBUTE_FILTER_BOOL",
      text: {
        en: ["required"],
        fa: ["اجباری"],
      },
    ...
    {
      generate_name: "media-max-width",
      id: "AST_LAYOUT_ATTRIBUTE_TYPE_RESPONSIVE_MAX_WIDTH",
      reserved_values: "",
      type: "AST_LAYOUT_ATTRIBUTE_FILTER_NUMBER",
      text: {
        en: ["media-max-width"],
    ...
    {
      generate_name: "media-max-height",
      id: "AST_LAYOUT_ATTRIBUTE_TYPE_RESPONSIVE_MAX_HEIGHT",
      reserved_values: "",
      type: "AST_LAYOUT_ATTRIBUTE_FILTER_NUMBER",
      text: {
        en: ["media-max-height"],
        fa: ["شرط حداکثر ارتفاع"],
      },
    },
    {
      generate_name: "media-min-width",
      id: "AST_LAYOUT_ATTRIBUTE_TYPE_RESPONSIVE_MIN_WIDTH",
      text: {
        en: ["media-min-width"],
        fa: ["شرط حداقل عرض"],
      },
    ...
    {
      generate_name: "media-min-height",
      id: "AST_LAYOUT_ATTRIBUTE_TYPE_RESPONSIVE_MIN_HEIGHT",
      text: {
        en: ["media-min-height"],
        fa: ["شرط حداقل ارتفاع"],
      },
